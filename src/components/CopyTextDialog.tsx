  ...
  return (
    ...
    >
        ...
        <textarea
          ...
          value={text}
          rows={14}
          className="w-full px-3 py-2 text-sm font-mono border border-line rounded-md bg-surface-sunken text-body resize-y focus:outline-none focus:ring-2 focus:ring-brand-focus focus:border-brand-edge"
        />
